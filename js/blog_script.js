window.onload = () => {
    ...
    const btns = document.querySelectorAll('.blog__section__buttons__container button')
    btns.forEach(val => {
            ...
            jQuery.ajax({
                ...
                success: function (res) {
                    ...
                    if (res == 'empty') {
                        ...
                        postsContainer.innerHTML = '<h3 style="text-align:center; color:#074E89">No hay artículos de esta categoria</h3>'
